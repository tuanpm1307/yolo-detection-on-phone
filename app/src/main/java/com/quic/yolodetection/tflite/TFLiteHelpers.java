        ...
        for (DelegateType[] delegatesToRegister : delegatePriorityOrder) {
            ...
            delegates.keySet().stream()
                    ...
                    .forEach(unusedDelegateType -> {
                        ...
                        Log.e("remove_delegate", ""+unusedDelegateType);
                    });
...
//            int[] op_lst={1}; // Avgpool
//            qnnOptions.setSkipOps(op_lst);
//            int[] node_lst={30,135,240,580,705};
//            qnnOptions.setSkipNodeIds(node_lst);
            /////////////////////////
            if (hasHTP_FP16) {
                Log.e("htp_precision", "HTP_PRECISION_FP16");
